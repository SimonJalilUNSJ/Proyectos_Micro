...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef *htim){
	...
	//1. Habilitar el reloj de periferico para timer5
	__HAL_RCC_TIM5_CLK_ENABLE();
	__HAL_RCC_GPIOA_CLK_ENABLE();

	//2. Configurar los gpios para que se comporten como canales de timer5 1, 2, 3 y 4
	/*
	PA0  --> TIM5_CH1
	PA1  --> TIM5_CH2
	PC11 --> TIM5_CH3
	...
	*/
	...
	tim5OC_ch_gpios.Pin			= GPIO_PIN_0;
